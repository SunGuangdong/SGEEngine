...
#define SGE_TRY_CATCH(code) \
	...
	const auto copyDirRecOverwrite =
	...
	SGE_TRY_CATCH(std::filesystem::copy(
	    SGE_DLL_PREFIX "SDL2d" SGE_DLL_SUFFIX, exportDir + "/" SGE_DLL_PREFIX "SDL2d" SGE_DLL_SUFFIX, copyOverwrite));
	SGE_TRY_CATCH(std::filesystem::copy(
	    SGE_DLL_PREFIX "SDL2" SGE_DLL_SUFFIX, exportDir + "/" SGE_DLL_PREFIX "SDL2" SGE_DLL_SUFFIX, copyOverwrite));
	SGE_TRY_CATCH(std::filesystem::copy(
	    SGE_DLL_PREFIX "sge_core" SGE_DLL_SUFFIX,
	    exportDir + "/" SGE_DLL_PREFIX "sge_core" SGE_DLL_SUFFIX,
	    copyOverwrite));
	SGE_TRY_CATCH(std::filesystem::copy(
	    SGE_DLL_PREFIX "sge_engine" SGE_DLL_SUFFIX,
	    exportDir + "/" SGE_DLL_PREFIX "sge_engine" SGE_DLL_SUFFIX,
	    copyOverwrite));
	SGE_TRY_CATCH(std::filesystem::copy(
	    SGE_DLL_PREFIX "sge_player" SGE_EXE_SUFFIX,
	    exportDir + "/" SGE_DLL_PREFIX "sge_player" SGE_EXE_SUFFIX,
	    copyOverwrite));
