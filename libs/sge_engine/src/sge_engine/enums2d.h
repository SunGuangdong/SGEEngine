...
/// Describes a textured plane orientation that in object space is facing +X with (bottom,left) point being at (0,0,0)
/// in object space.
...
/// @param [in] makeFacingPosZ used only for @billboarding=billboarding_none it makes the defalt facing to be +Z,
/// otherwise it is +X. The object is assumed that the face being rendered faces +X axis.
