...
/// @param [in] maxPenetrationDepth is the maximum allowed penetration, the physics engine needs some slack when solving
/// collision.
...
bool SGE_ENGINE_API computePenerationRecorverVectorFromManifold(
...
///
/// The code is based on the code in Bullet Physics, see btKinematicCharacterController::recoverFromPenetration.
bool SGE_ENGINE_API recoverFromPenetrationVector(
    btVector3& recoveryVector,
...
/// @param [out] recoveryVector the vector needed to move the body to get out of penetrations if there was any
/// penetratation.
/// @return true if there was any penetration.
bool SGE_ENGINE_API recoverFromPenetrationVector(
    btVector3& recoveryVector,
