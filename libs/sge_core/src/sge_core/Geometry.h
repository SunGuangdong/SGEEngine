...
struct Geometry {
	...
	Geometry(
	    ...
	    int firstBoneOffset, ///< The offset of the 1st bone of the mesh in @skinningBoneTransforms. -1 if there are no
	                         ///< bones.
  ...
  public:
	...
	VertexDeclIndex vertexDeclIndex =
	    VertexDeclIndex_Null; // The index of the vertex memory layout. See SGEDevice for more info.
